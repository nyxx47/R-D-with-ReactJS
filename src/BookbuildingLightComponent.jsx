...
import "./BookbuildingLightComponent.css";

const BookbuildingLightComponent = () => {
  ...
  return (
    <div className="bookbuilding-light-container">
      ...
      >
        ...
        {/* Dashed lines - light mode colors */}
        <path
        ...
        ></path>
        <path d="M229.5 343L11 216.5" stroke="#E5E5E5" strokeDasharray="6 6" />
        <path
        ...
        <rect
          ...
          fill="#FFFFFF"
          stroke="url(#paint3_linear_light)"
        ...
        <circle
          ...
          fill="#F5F5F5"
          stroke="url(#paint5_linear_light)"
          strokeWidth="0.186578"
        />
        <rect
          x="0.161584"
        ...
        <circle
          ...
          fill="#F5F5F5"
          stroke="url(#paint6_linear_light)"
          strokeWidth="0.186578"
        />
        <rect
          x="0.161584"
        ...
        <circle
          ...
          fill="#F5F5F5"
          stroke="url(#paint7_linear_light)"
          strokeWidth="0.186578"
        />
        <rect
          x="0.161584"
        ...
        <circle
          ...
          fill="#F5F5F5"
          stroke="url(#paint8_linear_light)"
          strokeWidth="0.186578"
        />
        {/* Vertical lines - light mode */}
        <path
          d="M186.75 183.25L186.75 214.75"
          stroke="url(#paint9_linear_light)"
          strokeOpacity="0.25"
          strokeWidth="0.5"
          strokeLinecap="round"
          strokeDasharray="2 2"
        ...
        <rect
          ...
          stroke="url(#paint10_linear_light)"
          strokeWidth="0.230791"
        />
        {/* Code text - light mode */}
        <path
          ...
          fill="url(#paint11_linear_light)"
        />
        {/* More vertical lines - light mode */}
        <path
          d="M265.75 137.25L265.75 168.75"
          stroke="url(#paint12_linear_light)"
          strokeOpacity="0.25"
          strokeWidth="0.5"
          strokeLinecap="round"
          strokeDasharray="2 2"
        ...
        <rect
          ...
          fill="url(#paint13_radial_light)"
        />
        <path
          d="M107.75 137.25L107.75 168.75"
          stroke="url(#paint14_linear_light)"
          strokeOpacity="0.25"
          strokeWidth="0.5"
          strokeLinecap="round"
          strokeDasharray="2 2"
        ...
        {/* Circles and additional elements - light mode */}
        <circle
          cx="37.3156"
          cy="37.3156"
          r="36.9425"
          ...
          fill="#FFFFFF"
          stroke="url(#paint17_linear_light)"
          strokeWidth="0.746313"
        />
        <circle
          cx="44.7788"
          ...
          r="44.4056"
          transform="matrix(0.866041 -0.499972 0.866041 0.499972 109.272 137.443)"
          stroke="url(#paint18_linear_light)"
          strokeWidth="0.746313"
        />
        {/* More device corners - light mode */}
        <rect
          x="0.161584"
          width="8.76918"
          height="8.76918"
        ...
        <circle
          ...
          fill="#F5F5F5"
          stroke="url(#paint19_linear_light)"
          strokeWidth="0.186578"
        />
        <rect
          x="0.161584"
        ...
        <circle
          ...
          fill="#F5F5F5"
          stroke="url(#paint20_linear_light)"
          strokeWidth="0.186578"
        />
        <rect
          x="0.161584"
        ...
        <circle
          ...
          fill="#F5F5F5"
          stroke="url(#paint21_linear_light)"
          strokeWidth="0.186578"
        />
        <rect
          x="0.161584"
        ...
        <circle
          ...
          fill="#F5F5F5"
          stroke="url(#paint22_linear_light)"
          strokeWidth="0.186578"
        />
        ...
        <g transform="matrix(0.866041 -0.499972 0.866041 0.499972 121.767 137.443)">
          {rectSize.width > 0 && (
            <rect
              ...
              rx={2}
              stroke="url(#paint23_linear_light)"
              strokeWidth="0.373156"
              fill="none"
            />
          )}
          <text
            ...
            dy="0.05em"
            fill="url(#paint24_linear_light)"
          >
            {label}
          </text>
        </g>
        {/* Definitions and gradients - light mode */}
        <defs>
          <clipPath
            id="bgblur_0_light_clip_path"
          ...
          >
            ...
            <feGaussianBlur
              ...
              result="effect1_foregroundBlur_light"
            />
          </filter>
          <filter
            id="filter2_f_light"
          ...
          >
            ...
            <feBlend
              mode="normal"
              in2="BackgroundImageFix"
              result="effect1_dropShadow_light"
            />
            <feBlend
              mode="normal"
              in="SourceGraphic"
          ...
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop stopColor="#000000" stopOpacity="0.05" />
            <stop offset="1" stopColor="#000000" stopOpacity="0.1" />
          </linearGradient>
          <linearGradient
            id="paint4_linear_light_updated"
            x1="115.296"
            y1="-32.5937"
            x2="-15.7722"
            y2="23.2743"
          ...
          >
            ...
            <stop offset="1" stopColor="#999999" stopOpacity="0.5" />
          </linearGradient>
          <linearGradient
            id="paint10_linear_light"
            x1="4.55976e-09"
            y1="6"
            x2="57.6923"
            y2="13.8462"
            gradientUnits="userSpaceOnUse"
          >
            <stop stopColor="#666666" stopOpacity="0.25" />
            <stop offset="1" stopColor="#999999" stopOpacity="0.05" />
          </linearGradient>
          <linearGradient
            id="paint11_linear_light"
            x1="204.55"
            y1="204.738"
            x2="227.498"
            y2="164.989"
          ...
          >
            ...
            <stop offset="1" stopColor="#D0D0D0" stopOpacity="0.8" />
          </radialGradient>
          <linearGradient
            id="paint14_linear_light"
            x1="107.25"
            y1="137.25"
            x2="107.25"
            y2="168.75"
...
export default BookbuildingLightComponent;
